...
public abstract class BaseRxDialog extends RxAppCompatDialogFragment implements View.OnClickListener {
    ...
    protected <T extends BaseRxDialog> BaseRxDialog(DialogBuilder<T> builder) {
...
//        super.show(manager, tag);
    ...
    public <T extends BaseRxDialog> T addDialogCallback(DialogCallback callback) {
    ...
    /** 移除DialogCallback回调 */
    public <T extends BaseRxDialog> T removeDialogCallback(DialogCallback callback) {
    ...
    public static class DialogBuilder<T extends BaseRxDialog> {
         ...
         *
         * @param clazz 弹窗类
         * @param <R>   继承于{@link BaseRxDialog}的子类
         */
        public static <R extends BaseRxDialog> DialogBuilder<R> newBuilder(Class<R> clazz) {
        ...
        private T createDefaultDialog() {
            return (T) new BaseRxDialog(this) {
                /** 初始化逻辑类对象 */
                @Override
